...
const Navbar = () => {
  ...
  return (
    <div className='max-w-[1130px] py-6 mx-auto flex flex-col md:flex-row gap-4 md:gap-20 items-center justify-between border-b-[.5px] border-zinc-700 overflow-visible px-4 md:px-0'>
      <div className='w-full md:w-auto flex items-center justify-between gap-16'>
